...
namespace admin
{
    public partial class AddUser : Form
    {
        ...
        private void addNewUser_Click(object sender, EventArgs e)
        {
            ...
            // Ellenőrizze, hogy minden mező ki van-e töltve
            if (string.IsNullOrEmpty(name) || string.IsNullOrEmpty(userEmail) || string.IsNullOrEmpty(password) || string.IsNullOrEmpty(confirmPassword) || string.IsNullOrEmpty(userPhone) || string.IsNullOrEmpty(userAddress))
            {
                ...
                return; // Ha bármelyik mező nincs kitöltve, ne folytassa tovább
            }

            // Ellenőrizze, hogy az email cím érvényes formátumú-e
            if (!IsValidEmail(userEmail))
            {
                ...
                return; // Ha az email cím érvénytelen, ne folytassa tovább
            }

            // Ellenőrizze, hogy a jelszó és a megerősített jelszó egyezik-e
            if (password != confirmPassword)
            {
                ...
                return; // Ha a jelszavak nem egyeznek, ne folytassa tovább
            }

            // Ellenőrizze, hogy a jelszó megfelelő hosszúságú, tartalmaz-e speciális karaktereket és számot
            if (!IsValidPassword(password))
            {
                ...
                return; // Ha a jelszó nem megfelelő, ne folytassa tovább
            }

            // Ellenőrizze, hogy a telefonszám megfelelő formátumú-e
            if (!IsValidPhoneNumber(userPhone))
            {
                ...
                return; // Ha a telefonszám nem megfelelő, ne folytassa tovább
            }
            ...
            try
            {
                ...
                // Ellenőrizze, hogy sikeresen hozzáadásra került-e az új felhasználó
                if (affectedRows == 0)
                {
        ...
        // Ellenőrzi, hogy az email cím érvényes formátumú-e
        ...
        // Ellenőrzi, hogy a jelszó megfelelő formátumú-e
        ...
        // Ellenőrzi, hogy a telefonszám megfelelő formátumú-e
        ...
        {
            this.allusersviewTableAdapter.Fill(this.watchesDataSet3.allusersview);
        ...
        private void modifyBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // Ellenőrizze, hogy van-e változás az adatokban
                ...
                // Ellenőrizzük, hogy az új telefonszám már létezik-e az adatbázisban
        ...
        // Ellenőrzi, hogy a telefonszám létezik-e az adatbázisban
